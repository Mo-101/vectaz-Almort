      ...
      <CardContent className="p-3 sm:p-4 h-64 sm:h-80 md:h-96">
        <ResponsiveContainer width="100%" height="100%">
          <BarChart data={chartData} layout="vertical" margin={{ top: 5, right: 30, left: 20, bottom: 5 }}>
            ...
            <XAxis type="number" domain={[0, 100]} tickFormatter={(value) => `${value}%`} stroke="#94A3B8" />
            <YAxis 
              dataKey="forwarder" 
              type="category" 
              width={100} 
            ...
            <Bar 
              ...
              label={{ 
                ...
                content: (props: any) => {
                  ...
                  return (
                    <text x={x + width + 5} y={y + height/2} fill="#FFFFFF" textAnchor="start" dominantBaseline="middle">
                      {value}%
                    </text>
                  );
                }
