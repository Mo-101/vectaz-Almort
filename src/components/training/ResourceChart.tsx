          ...
          <ChartContainer config={chartConfig}>
            <ResponsiveContainer width="100%" height="100%">
              ...
              bottom: 5
                ...
                {resources.gpu && <Line type="monotone" dataKey="GPU" stroke={chartConfig.GPU.color} strokeWidth={2} dot={false} />}
              </LineChart>
            </ResponsiveContainer>
          </ChartContainer>
        </div>
        
        {metrics && <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mt-6">
